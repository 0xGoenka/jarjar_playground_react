...
// node_modules/vaul/node_modules/@radix-ui/react-slot/dist/index.mjs
...
function useControllableState({ prop, defaultProp, onChange = () => {
  ...
  const handleChange = useCallbackRef(onChange);
  const setValue = import_react3.default.useCallback((nextValue) => {
    if (isControlled) {
...
function useSnapPoints({ activeSnapPointProp, setActiveSnapPointProp, snapPoints, drawerRef, overlayRef, fadeFromIndex, onSnapPointChange, direction = "bottom" }) {
  ...
  const isLastSnapPoint = import_react3.default.useMemo(() => activeSnapPoint === (snapPoints == null ? void 0 : snapPoints[snapPoints.length - 1]) || null, [
    snapPoints,
    activeSnapPoint
  ]);
  const shouldFade = snapPoints && snapPoints.length > 0 && (fadeFromIndex || fadeFromIndex === 0) && !Number.isNaN(fadeFromIndex) && snapPoints[fadeFromIndex] === activeSnapPoint || !snapPoints;
  const activeSnapPointIndex = import_react3.default.useMemo(() => snapPoints == null ? void 0 : snapPoints.findIndex((snapPoint) => snapPoint === activeSnapPoint), [
    snapPoints,
    activeSnapPoint
  ]);
  ...
  const activeSnapPointOffset = import_react3.default.useMemo(() => activeSnapPointIndex !== null ? snapPointsOffset == null ? void 0 : snapPointsOffset[activeSnapPointIndex] : null, [
    snapPointsOffset,
    activeSnapPointIndex
  ]);
  const snapToPoint = import_react3.default.useCallback((dimension) => {
...
function Root({ open: openProp, onOpenChange, children, shouldScaleBackground, onDrag: onDragProp, onRelease: onReleaseProp, snapPoints, nested = false, setBackgroundColorOnScale = true, closeThreshold = CLOSE_THRESHOLD, scrollLockTimeout = SCROLL_LOCK_TIMEOUT, dismissible = true, handleOnly = false, fadeFromIndex = snapPoints && snapPoints.length - 1, activeSnapPoint: activeSnapPointProp, setActiveSnapPoint: setActiveSnapPointProp, fixed, modal = true, onClose, noBodyStyles, direction = "bottom", preventScrollRestoration = true, disablePreventScroll = false }) {
  ...
  return import_react3.default.createElement($5d3850c4d0b4e6c7$export$be92b6f5f03c0fe9, {
    modal,
    onOpenChange: (o) => {
      if (openProp !== void 0) {
    ...
    open: isOpen
  }, import_react3.default.createElement(DrawerContext.Provider, {
    value: {
      visible,
      activeSnapPoint,
      snapPoints,
...
var Handle = import_react3.default.forwardRef(function({ preventCycle = false, children, ...rest }, ref) {
...
var Overlay = import_react3.default.forwardRef(function({ children, ...rest }, ref) {
  const { overlayRef, snapPoints, onRelease, shouldFade, isOpen, visible } = useDrawerContext();
  const composedRef = useComposedRefs(ref, overlayRef);
  const hasSnapPoints = snapPoints && snapPoints.length > 0;
  return import_react3.default.createElement($5d3850c4d0b4e6c7$export$c6fdb837b070b4ff, {
    onMouseUp: onRelease,
    ref: composedRef,
    "vaul-drawer-visible": visible ? "true" : "false",
    "vaul-overlay": "",
...
var Content = import_react3.default.forwardRef(function({ onOpenAutoFocus, onPointerDownOutside, onAnimationEnd, style, ...rest }, ref) {
  ...
  return import_react3.default.createElement($5d3850c4d0b4e6c7$export$7c6e2c02157bb7d2, {
    "vaul-drawer": "",
