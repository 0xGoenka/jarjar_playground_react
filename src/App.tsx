...
import { MintedNfts } from "./components/pages/MintedNfts";
          ...
          <WalletProvider autoConnect>
            ...
            {/* <div className="max-w-screen-lg mx-auto">
              ...
              <div className="mt-32 mb-8">
                By generating this NFT, you make yourself eligible for the
                $JARJAR airdrop. The airdrop will be distributed to all holders
                of the JARJAR 1# collection on the Sui blockchain.
                <br />
                <br />
                ...
                <br />
                <br />
                Airdrop rewards will be distributed in the form of $JARJAR
                tokens, which can be used to interact with the JARJAR ecosystem,
                including participating in the JARJAR DAO, contributing to the
                JARJAR community, and receiving rev share rewards from oracles
                fees.
              </div>
            </div> */}
          </WalletProvider>
